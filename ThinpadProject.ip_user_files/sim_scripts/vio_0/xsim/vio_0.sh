...
elaborate()
{
  $xv_path/bin/xelab --relax --debug typical --mt auto -L xil_defaultlib -L secureip -L xpm --snapshot vio_0 xil_defaultlib.vio_0 -log elaborate.log
}
...
{
  file="xsim.ini"
  lib_map_path="/user_program/Xlinx/Vivado/2017.1/data/xsim"
  if [[ ($1 != "") ]]; then
    lib_map_path="$1"
  fi
