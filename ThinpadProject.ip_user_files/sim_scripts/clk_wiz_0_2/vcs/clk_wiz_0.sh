...
#
# Generated by Vivado on Fri Jan 05 04:01:21 CST 2018
...
compile()
{
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"$ref_dir/../../../ipstatic" \
    "$ref_dir/../../../../ThinpadProject.srcs/sources_1/ip/clk_wiz_0_2/clk_wiz_0_clk_wiz.v" \
    "$ref_dir/../../../../ThinpadProject.srcs/sources_1/ip/clk_wiz_0_2/clk_wiz_0.v" \
  2>&1 | tee -a vlogan.log
...
create_lib_mappings()
{
  ...
  if [[ ($1 != "") ]]; then
    ...
    lib_map_path="/home/zhanghuimeng/Computer_Architecture/second/ThinpadProject/ThinpadProject.cache/compile_simlib/vcs"
  fi
